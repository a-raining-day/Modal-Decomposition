...
/***********************************************************
* Third-party notice: this file originates from the Smithsonian
* Astrophysical Observatory (SAO), Submillimeter Receiver
* Laboratory, "am" project (S. Paine), and was acquired via
