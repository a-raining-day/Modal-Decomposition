...
from .Hilbert import hilbert  # TODO: Hilbert 后端选择尚未完成(见 Utils/_Hilbert)
from ..Base.Cache import cache


_CACHE_KEY_SIGNAL = "scipy.signal"
_CACHE_KEY_INTERPOLATE = "scipy.interpolate"
...
def envelope(S: np.ndarray, method: Literal["Hilbert", "Lowpass", "IQ", "PeakInterpolation"] = "Hilbert", fs: float = None, fc: float = None, cf: float = None, **kwargs) -> np.ndarray:
    ...
    # TODO: the choose of Hilbert method is not finish.
